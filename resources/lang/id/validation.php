...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut berisi pesan validasi default yang digunakan oleh
    ...
    */
    ...
    'required_without_all' => 'Kolom :attribute wajib diisi bila tidak ada satupun dari :values ada.',
    ...
    | menggunakan konvensi "attribute.rule". Hal ini memudahkan untuk memberikan
    | pesan spesifik pada aturan tertentu untuk atribut tertentu.
    |
    */
