...
@section('css')
    <style>
        ...
        .form-control {
            ...
            min-height: 48px; /* Tinggi minimum untuk semua input */
            box-sizing: border-box;
        }
        
        /* Form Select yang Lebih Tinggi */
        .form-control.select {
            min-height: 52px; /* Lebih tinggi dari input biasa */
            padding: 0.875rem 1rem; /* Padding yang lebih besar */
            appearance: none; /* Hilangkan style default browser */
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='m6 8 4 4 4-4'/%3e%3c/svg%3e");
            background-position: right 0.75rem center;
            background-repeat: no-repeat;
            background-size: 16px 12px;
            padding-right: 2.5rem; /* Space untuk dropdown arrow */
        }
                ...
                <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" id="productForm">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="barcode" class="form-control @error('barcode') is-invalid @enderror" 
                                    id="barcode" placeholder="{{ __('product.Enter_Barcode') }}" 
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <div class="price-input-container">
                                    ...
                                    <input type="number" name="price" class="form-control price-input @error('price') is-invalid @enderror" 
                                        id="price" placeholder="{{ __('product.Enter_Price') }}" 
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" class="form-control @error('quantity') is-invalid @enderror" 
                                    id="quantity" placeholder="{{ __('product.Enter_Quantity') }}" 
                    ...
                    <div class="form-section">
                        <div class="form-group">
                            ...
                            <div class="character-count" id="descriptionCount">{{ strlen(old('description', $product->description)) }} characters</div>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
