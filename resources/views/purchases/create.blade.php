...
@section('title', __('purchase.Create_Purchase'))
@section('content-header', __('purchase.Create_Purchase'))
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="invoice_number"
                                    ...
                                    placeholder="{{ __('purchase.Invoice_Number') }}" value="{{ old('invoice_number') }}"
                                    required>
