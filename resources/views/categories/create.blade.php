...
@section('title', isset($category) ? __('category.Edit_Category') : __('category.Create_Category'))
@section('content-header', isset($category) ? __('category.Edit_Category') : __('category.Create_Category'))
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ isset($category) ? route('categories.update', $category) : route('categories.store') }}"
                    ...
                    @if(isset($category))
                        <div class="form-section">
                            <h3 class="form-section-title">{{ __('category.Additional_Information') }}</h3>
                            <div class="form-grid">
                                <div class="form-group">
                                    <label class="form-label">{{ __('category.Created_At') }}</label>
                                    <div class="form-control" style="background-color: #f9fafb;">
                                        {{ $category->created_at->format('d M Y, H:i') }}
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">{{ __('category.Updated_At') }}</label>
                                    <div class="form-control" style="background-color: #f9fafb;">
